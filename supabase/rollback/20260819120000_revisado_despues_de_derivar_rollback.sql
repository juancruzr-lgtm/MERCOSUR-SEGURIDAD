-- ROLLBACK de 20260819120000_revisado_despues_de_derivar
--
-- Restaura revisar_primer_control tal como estaba en
-- 20260805150000_revision_supervisor_planilla.
--
-- OJO: al volver atras, marcar "revisado" sobre una fila ya derivada vuelve a
-- no hacer nada, y la fila queda en la bandeja sin forma de sacarla.
--
-- No borra ninguna fila de revisiones_planilla: las que se hayan registrado
-- mientras la correccion estuvo activa quedan, y son historial valido.
