-- ROLLBACK de 20260729190000. Restaura en obtener_rondas_guardia_actual() la
-- copia inline de la ventana de turno vigente, tal como quedó definida en
-- 20260727120000_rondas_lectura_guardia.sql (líneas 17-140).
--
-- Reintroduce la duplicación a propósito: es el estado previo exacto. No toca
-- rondas_turno_vigente(), que sigue siendo la definición que usan las demás RPC.
