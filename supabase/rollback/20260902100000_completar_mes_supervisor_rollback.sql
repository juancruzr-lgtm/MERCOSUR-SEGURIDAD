-- Rollback de 20260902100000_completar_mes_supervisor
--
-- Restaura crear_turnos_programacion_parcial a su version admin-only (el
-- cuerpo exacto de 20260807120000_generacion_sin_retroactivos, vigente antes
-- de habilitar supervisores). Misma firma, mismos grants: un solo CREATE OR
-- REPLACE, sin tocar datos ni auditoria. Los turnos ya creados por
-- supervisores no se tocan: revertir el permiso no borra trabajo hecho.
